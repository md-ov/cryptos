...
cryptos-apps to-parquets-from-csv --master local --api trades --input-dir D:\\ws\\cryptos\\data\\trades\\xxbt-before-$now --parquets-dir file:///D:\\ws\\cryptos\\data\\parquets --minimum 1