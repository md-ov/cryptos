...
class SeqDoubleHelperTest extends FunSuite {
    
    test("seq 0") {
        val values = Seq(1D, 2D)
        
        val seqMax = SeqDoubleHelper.getMax(values, 4, 4)
        val seqMin = SeqDoubleHelper.getMin(values, 4, 4)
    ...
    test("seq 0 fast") {
        ...
        val seqMax = SeqDoubleHelper.getMaxFast(values, 4, 4)
        val seqMin = SeqDoubleHelper.getMinFast(values, 4, 4)
    ...
    test("seq 2") {
        ...
        val seqMax = SeqDoubleHelper.getMax(values, 3, 3)
        val seqMin = SeqDoubleHelper.getMin(values, 3, 3)
    ...
    test("seq 2 fast") {
        ...
        val seqMax = SeqDoubleHelper.getMaxFast(values, 3, 3)
        val seqMin = SeqDoubleHelper.getMinFast(values, 3, 3)
